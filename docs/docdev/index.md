...
This section is for contributors who want to understand the **internal engine** of Leaspy. If you just want to use Leaspy to analyze data, check out the [User Guide](../user_guide.md).
