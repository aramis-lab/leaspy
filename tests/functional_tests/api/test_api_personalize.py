...
class LeaspyPersonalizeTest(LeaspyPersonalizeTestMixin):
    def test_personalize_mean_post_logistic_old(self):
        """
        ...
        path_settings = self.get_test_data_path(
            "settings", "algo", "settings_mean_post_old_with_annealing.json"
        )
    ...
    def test_personalize_mode_post_logistic_old(self):
        """
        Load logistic model from file, and personalize it to data from ...
        """
        # cf. mean_real notice
        path_settings = self.get_test_data_path(
            "settings", "algo", "settings_mode_post_old_with_annealing.json"
        )
        with self.assertWarnsRegex(UserWarning, r"[Aa]nnealing"):
            ips, _ = self.generic_personalization(
                "logistic_scalar_noise", algo_path=path_settings
    ...
    def test_multivariate_logistic_mode_post(self):
        self._personalize_generic("logistic_scalar_noise", "mode_post")

    def test_multivariate_logistic_mean_post(self):
        self._personalize_generic("logistic_scalar_noise", "mean_post")
    ...
    def test_multivariate_logistic_diagonal_id_mode_post(self):
        self._personalize_generic(
            "logistic_diag_noise_id",
            "mode_post",
        )

    def test_multivariate_logistic_diagonal_id_mean_post(self):
        self._personalize_generic(
            "logistic_diag_noise_id",
            "mean_post",
        )
    ...
    def test_multivariate_logistic_diagonal_mode_post(self):
        self._personalize_generic(
            "logistic_diag_noise",
            "mode_post",
        )

    def test_multivariate_logistic_diagonal_mean_post(self):
        self._personalize_generic(
            "logistic_diag_noise",
            "mean_post",
        )
    ...
    def test_multivariate_logistic_diagonal_no_source_mode_post(self):
        self._personalize_generic(
            "logistic_diag_noise_no_source",
            "mode_post",
        )

    def test_multivariate_logistic_diagonal_no_source_mean_post(self):
        self._personalize_generic(
            "logistic_diag_noise_no_source",
            "mean_post",
        )
    ...
    @skipIf(not TEST_LOGISTIC_PARALLEL_MODELS, SKIP_LOGISTIC_PARALLEL_MODELS)
    def test_multivariate_logistic_parallel_mode_post(self):
        self._personalize_generic(
            "logistic_parallel_scalar_noise",
            "mode_post",
        )
    ...
    @skipIf(not TEST_LOGISTIC_PARALLEL_MODELS, SKIP_LOGISTIC_PARALLEL_MODELS)
    def test_multivariate_logistic_parallel_mean_post(self):
        self._personalize_generic(
            "logistic_parallel_scalar_noise",
            "mean_post",
        )
    ...
    @skipIf(not TEST_LOGISTIC_PARALLEL_MODELS, SKIP_LOGISTIC_PARALLEL_MODELS)
    def test_multivariate_logistic_parallel_diagonal_mode_post(self):
        self._personalize_generic(
            "logistic_parallel_diag_noise",
            "mode_post",
        )
    ...
    @skipIf(not TEST_LOGISTIC_PARALLEL_MODELS, SKIP_LOGISTIC_PARALLEL_MODELS)
    def test_multivariate_logistic_parallel_diagonal_mean_post(self):
        self._personalize_generic(
            "logistic_parallel_diag_noise",
            "mean_post",
        )
    ...
    def test_univariate_logistic_mode_post(self):
        self._personalize_generic(
            "univariate_logistic",
            "mode_post",
        )

    def test_univariate_logistic_mean_post(self):
        self._personalize_generic(
            "univariate_logistic",
            "mean_post",
        )
    ...
    def test_univariate_joint_mode_post(self):
        self._personalize_generic(
            "univariate_joint",
            "mode_post",
        )

    def test_univariate_joint_mean_post(self):
        self._personalize_generic(
            "univariate_joint",
            "mean_post",
        )
    ...
    def test_joint_mode_post(self):
        self._personalize_generic(
            "joint_diagonal",
            "mode_post",
        )

    def test_joint_mean_post(self):
        self._personalize_generic(
            "joint_diagonal",
            "mean_post",
        )
    ...
    @skipIf(not TEST_LINEAR_MODELS, SKIP_LINEAR_MODELS)
    def test_univariate_linear_mode_post(self):
        self._personalize_generic(
            "univariate_linear",
            "mode_post",
        )
    ...
    @skipIf(not TEST_LINEAR_MODELS, SKIP_LINEAR_MODELS)
    def test_univariate_linear_mean_post(self):
        self._personalize_generic(
            "univariate_linear",
            "mean_post",
        )
    ...
    @skipIf(not TEST_LINEAR_MODELS, SKIP_LINEAR_MODELS)
    def test_multivariate_linear_mode_post(self):
        self._personalize_generic(
            "linear_scalar_noise",
            "mode_post",
        )
    ...
    @skipIf(not TEST_LINEAR_MODELS, SKIP_LINEAR_MODELS)
    def test_multivariate_linear_mean_post(self):
        self._personalize_generic(
            "linear_scalar_noise",
            "mean_post",
        )
    ...
    @skipIf(not TEST_LINEAR_MODELS, SKIP_LINEAR_MODELS)
    def test_multivariate_linear_diagonal_mode_post(self):
        self._personalize_generic(
            "linear_diag_noise",
            "mode_post",
        )
    ...
    @skipIf(not TEST_LINEAR_MODELS, SKIP_LINEAR_MODELS)
    def test_multivariate_linear_diagonal_mean_post(self):
        self._personalize_generic(
            "linear_diag_noise",
            "mean_post",
        )
    ...
    @skipIf(not TEST_LOGISTIC_BINARY_MODELS, SKIP_LOGISTIC_BINARY_MODELS)
    def test_multivariate_binary_mode_post(self):
        self._personalize_generic(
            "logistic_binary",
            "mode_post",
        )
    ...
    @skipIf(not TEST_LOGISTIC_BINARY_MODELS, SKIP_LOGISTIC_BINARY_MODELS)
    def test_multivariate_binary_mean_post(self):
        self._personalize_generic(
            "logistic_binary",
            "mean_post",
        )
    ...
    @skipIf(not TEST_LOGISTIC_PARALLEL_MODELS, SKIP_LOGISTIC_PARALLEL_MODELS)
    def test_multivariate_parallel_binary_mode_post(self):
        self._personalize_generic(
            "logistic_parallel_binary",
            "mode_post",
        )
    ...
    @skipIf(not TEST_LOGISTIC_PARALLEL_MODELS, SKIP_LOGISTIC_PARALLEL_MODELS)
    def test_multivariate_parallel_binary_mean_post(self):
        self._personalize_generic(
            "logistic_parallel_binary",
            "mean_post",
        )
    ...
    @skipIf(not TEST_ORDINAL_MODELS, SKIP_ORDINAL_MODELS)
    def test_multivariate_ordinal_mode_post(self):
        self._personalize_generic(
            "logistic_ordinal",
            "mode_post",
        )
    ...
    @skipIf(not TEST_ORDINAL_MODELS, SKIP_ORDINAL_MODELS)
    def test_multivariate_ordinal_mean_post(self):
        self._personalize_generic(
            "logistic_ordinal",
            "mean_post",
        )
    ...
    @skipIf(not TEST_ORDINAL_MODELS, SKIP_ORDINAL_MODELS)
    def test_multivariate_ordinal_ranking_mode_post(self):
        self._personalize_generic(
            "logistic_ordinal_ranking",
            "mode_post",
        )
    ...
    @skipIf(not TEST_ORDINAL_MODELS, SKIP_ORDINAL_MODELS)
    def test_multivariate_ordinal_ranking_mean_post(self):
        self._personalize_generic(
            "logistic_ordinal_ranking",
            "mean_post",
        )
...
class LeaspyPersonalizeRobustnessDataSparsityTest(LeaspyPersonalizeTestMixin):
    ...
    def test_multivariate_logistic_parallel_mode_post(self):
        self._robustness_to_data_sparsity(
            "logistic_parallel_scalar_noise", "mode_post", 0.1517
        )

    @skipIf(not TEST_LOGISTIC_PARALLEL_MODELS, SKIP_LOGISTIC_PARALLEL_MODELS)
    def test_multivariate_logistic_parallel_mean_post(self):
        self._robustness_to_data_sparsity(
            "logistic_parallel_scalar_noise", "mean_post", 0.2079
        )
